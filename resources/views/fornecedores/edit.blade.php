                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('nomeforn') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('nomeforn') ? ' is-invalid' : '' }}" name="nomeforn" id="input-nomeforn" type="text" placeholder="{{ __('Nome do Fornecedor') }}" value="{{$fornecedor->nomeforn}}" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                <div class="row">
